...
export interface AppAction {
    type: typeof ADD_PLAYER | typeof REMOVE_PLAYER | typeof SET_PLAYER_NAME | typeof SUBTRACT_PLAYER_POINTS | typeof SET_GAME_STATE | typeof SET_PLAYER_COLOR,
    payload?: any
}
...
export const setPlayerColor = (payload: { color: string, index: number }): AppAction => ({
